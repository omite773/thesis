...
#    if(dataready() == True):
    ...
    tvc = (buf[2] << 8) | buf[3]
#    else:
#        print("CO2 sensor needs to warm up.")
    return [co,tvc]

def set_environment(temperature, humidity):
...
set_environment(22, 65)
init_ccs811(0x10)
if(dataready() == True):
    (co2, tvoc) = read_gas()
else:
    print("The CO2 sensor needs to warm up.")
