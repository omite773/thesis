...
static const u1_t DEVKEY[16] = { 0x8D, 0xAF, 0x5B, 0x98, 0xFB, 0x78, 0xE1, 0x9A, 0x49, 0x49, 0xD0, 0xE3, 0x3D, 0x32, 0xA6, 0x8C };

// LoRaWAN AppSKey, application session key
// Use this key to get your data decrypted by The Things Network
static const u1_t ARTKEY[16] = { 0x54, 0x80, 0xDE, 0x36, 0xF8, 0x0A, 0x19, 0xD5, 0x41, 0x21, 0x49, 0x40, 0xFE, 0x02, 0x76, 0x7B };

// LoRaWAN end-device address (DevAddr)
// See http://thethingsnetwork.org/wiki/AddressSpace
static const u4_t DEVADDR = 0x26011CA6; // <-- Change this address for every node!
...
static void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & (1 << 7)) {
      ...
      float *sensor_values = get_sensor_values();
      //printf( "sensor value in do_send: %.2lf\n", *(sensor_values+0));
      //     char buf[100];
      ...
      printf("temp to be sent: %.2lf: ", temp);
      LMIC_setTxData2(1, (uint8_t*) &temp, sizeof(float), 0);
    }
